 ...
 *
 *         Esta classe desenvolve toda a interface gráfica do Jogo da Forca bem
 *         como todos os eventos relacionados aos botões do jogo
 * 
 *         Janeiro 2006
 */
public class Interface extends JFrame implements ActionListener, ItemListener {
	 ...
	 * entrada (até que o ususário realize uma ação)
	 */
	public Interface() {
		super("Jogo da Forca");
		configuraJFrame();
	...
	// método que atualiza o painel dos segredo para que as letras possam aparecer
	// assim que o usuário digitar
	...
	public void eventoMenu(ActionEvent e) {
		...
		if (e.getSource() == this.solucao) {
			if (this.nivelAtual == 0) {
				...
				JOptionPane.showMessageDialog(null, "A SOLUÇÃO É " + this.jogo.getSegredo(), "Resposta",
