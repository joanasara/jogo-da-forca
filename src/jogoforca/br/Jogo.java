...
public class Jogo {
	...
	// método que prepara o jogo e inicializa as variáveis fazendo as verificações
	// necessárias
	...
	// método que verifica se tem a letra que o usuário digitou considerando os
	// casos especiais (á,é,ã,õ, etc)
	...
	// método que atualiza a palavra (segredo 2) para que aparecça para o usuário o
	// estado atual da sua descoberta
